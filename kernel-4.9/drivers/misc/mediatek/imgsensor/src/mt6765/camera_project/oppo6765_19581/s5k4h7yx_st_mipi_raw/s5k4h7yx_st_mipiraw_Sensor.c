...
#include "s5k4h7yx_st_mipiraw_Sensor.h"


#define PFX "s5k4h7yx_st_camera_sensor"
...
extern char read_module_id(void);
...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K4H7YX_ST_SENSOR_ID,
...
kal_uint16 otp_4h7_st_read_cmos_sensor(kal_uint32 addr)
{
...
void otp_4h7_st_write_cmos_sensor_8(kal_uint16 addr, kal_uint8 para)
{
	write_cmos_sensor_8(addr, para);
}
unsigned char S5K4H7_ST_read_cmos_sensor(u32 addr)
{
	kal_uint16 get_byte = 0;
...
void S5K4H7_ST_write_cmos_sensor(u16 addr, u32 para)
{
    char pusendcmd[3] = {(char)(addr >> 8), (char)(addr & 0xFF), (char)(para & 0xFF)};
...
UINT32 S5K4H7YX_ST_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
