...
#define PFX "ov12a10_qtech_camera_sensor"
...
#include "ov12a10qtechmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV12A10_QTECH_SENSOR_ID,
...
static kal_uint16 ov12a10_qtech_table_write_cmos_sensor(
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov12a10_qtech[] = {
	0x0103, 0x01,
	0x0302, 0x49,
	0x0303, 0x00,
	0x0304, 0x00,
...
static void sensor_init(void) //check out
{
	...
	ov12a10_qtech_table_write_cmos_sensor(
		addr_data_pair_init_ov12a10_qtech,
		sizeof(addr_data_pair_init_ov12a10_qtech) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov12a10_qtech[] = {
	0x3642, 0x10,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
#if MULTI_WRITE
	ov12a10_qtech_table_write_cmos_sensor(
		addr_data_pair_preview_ov12a10_qtech,
		sizeof(addr_data_pair_preview_ov12a10_qtech) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov12a10_qtech[] = {
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
kal_uint16 addr_data_pair_capture_24fps_ov12a10_qtech[] = {
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
kal_uint16 addr_data_pair_capture_30fps_ov12a10_qtech[] = {
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
kal_uint16 addr_data_normal_video_30fps_ov12a10_qtech[] = {
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
static void capture_setting(kal_uint16 currefps)//jack yan check
{
	...
	if (currefps == 150) {
	ov12a10_qtech_table_write_cmos_sensor(
		addr_data_pair_capture_15fps_ov12a10_qtech,
		sizeof(addr_data_pair_capture_15fps_ov12a10_qtech) /
		sizeof(kal_uint16));
	} else if (currefps == 240) {
	ov12a10_qtech_table_write_cmos_sensor(
		addr_data_pair_capture_24fps_ov12a10_qtech,
		sizeof(addr_data_pair_capture_24fps_ov12a10_qtech) /
		sizeof(kal_uint16));
	} else {
	ov12a10_qtech_table_write_cmos_sensor(
		addr_data_pair_capture_30fps_ov12a10_qtech,
		sizeof(addr_data_pair_capture_30fps_ov12a10_qtech) /
		sizeof(kal_uint16));
	}
#else
	if (currefps == 150) {
...
#if MULTI_WRITE
	ov12a10_qtech_table_write_cmos_sensor(
		addr_data_normal_video_30fps_ov12a10_qtech,
		sizeof(addr_data_normal_video_30fps_ov12a10_qtech) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x3642, 0x12);
	write_cmos_sensor(0x3666, 0x08);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov12a10_qtech[] = {
	0x3642, 0x08,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
#if MULTI_WRITE
	ov12a10_qtech_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov12a10_qtech,
		sizeof(addr_data_pair_hs_video_ov12a10_qtech) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_custom2_24fps_ov12a10_qtech[] = {
	0x3642, 0x12,
	0x3666, 0x08,
	0x366b, 0x20,
	0x366c, 0xa4,
...
#if MULTI_WRITE
	ov12a10_qtech_table_write_cmos_sensor(
		addr_data_pair_custom2_24fps_ov12a10_qtech,
		sizeof(addr_data_pair_custom2_24fps_ov12a10_qtech) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x3642, 0x12);
	write_cmos_sensor(0x3666, 0x08);
	...
	do {
		*sensor_id = return_sensor_id()+2;
		if (*sensor_id == imgsensor_info.sensor_id) {
			if(0x05 == return_otp(0x00)){
				LOG_INF("ov12a10 qtech read[get_imgsensor_id] sensor id: 0x%x\n",
					*sensor_id);
				return ERROR_NONE;
			}else{
			...
			MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	imgsensor.frame_length = imgsensor_info.pre.framelength;
	imgsensor.min_frame_length = imgsensor_info.pre.framelength;
	// yinlili@ODM_HQ Cam.Algo  20200225 modified for coverity issue:22224
			...
			MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	// yinlili@ODM_HQ Cam.Algo  20200225 modified for coverity issue:83372
	//imgsensor.current_fps = imgsensor.current_fps;
	spin_unlock(&imgsensor_drv_lock);
	custom1_setting();
	return ERROR_NONE;
			...
			MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	// yinlili@ODM_HQ Cam.Algo  20200225 modified for coverity issue:83306
	//imgsensor.current_fps = imgsensor.current_fps;
	spin_unlock(&imgsensor_drv_lock);
	custom2_setting();
	return ERROR_NONE;
			...
			MUINT32 framerate)
{
	...
	break;
	case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
		// yinlili@ODM_HQ Cam.Algo  20200225 modified for coverity issue:22203
		//if (framerate == 0)
		//	return ERROR_NONE;
...
UINT32 OV12A10_QTECH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
	{
