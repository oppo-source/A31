...
/*
 * DW9718TAF_QTECH voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "DW9718TAF_QTECH_DRV"
...
static int s4DW9718TAF_QTECH_ReadReg(unsigned short *a_pu2Result)
{
...
/* ////////////////////////////////////////////////////////////// */
long DW9718TAF_QTECH_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int DW9718TAF_QTECH_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int DW9718TAF_QTECH_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int DW9718TAF_QTECH_GetFileName(unsigned char *pFileName)
{
