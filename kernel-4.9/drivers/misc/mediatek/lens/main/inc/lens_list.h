...
#define DW9718TAF_QTECH_SetI2Cclient DW9718TAF_QTECH_SetI2Cclient_Main
#define DW9718TAF_QTECH_Ioctl DW9718TAF_QTECH_Ioctl_Main
#define DW9718TAF_QTECH_Release DW9718TAF_QTECH_Release_Main
#define DW9718TAF_QTECH_GetFileName DW9718TAF_QTECH_GetFileName_Main
extern int DW9718TAF_QTECH_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9718TAF_QTECH_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9718TAF_QTECH_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int DW9718TAF_QTECH_GetFileName(unsigned char *pFileName);
#endif
